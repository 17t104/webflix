<link rel="icon" href="https://banner2.cleanpng.com/20180426/tuq/kisspng-wilson-prostaff-original-6-0-wilson-sporting-goods-w-logo-5ae1e45f257cc5.1871228615247535031536.jpg">
<?php
//Default Configuration
$CONFIG = '{"lang":"en","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":true}';
...
//Application Title
define('APP_TITLE', 'Webflix | All in 1 Movie Center');
...
if (defined('FM_EMBED')) {
    ...
    function session_error_handling_function($code, $msg, $file, $line) {
        ...
        if ($code == 2) {
            session_abort();
            FM_SESSION_ID(session_create_id());
            @session_start();
        }
    }
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <img src="https://canniefish.weebly.com/uploads/1/1/8/3/118361953/webflix_orig.png" max-width="50px" max-height="80px" aria-label="SoftoShare">
                                        </div>
                        ...
                        <div class="footer text-center">
                            ...
                            <h5 >©Powered by Innovation Technologies</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3>Powered By Anderson</h3></p>
                        <p>Company: Innovation Technologies</p>
                        <p>Mail Us: <a href="mailto:innovationtechnologiespvtltd@gmail.com">innovationtechnologiespvtltd@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://learncodeweb.com/web-development/mp3-player-with-a-working-example-in-php-mysql-and-ajax/" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="mailto:arunrs0966@gmail.com" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <li class="list-group-item"><a href="https://www.google.com/search?sxsrf=ALeKk00AY5ebmrnUIPYX-EgL8TQV2KkXJQ%3A1594730909448&source=hp&ei=nakNX7mfGYGLmgfe1ZTwDw&q=latest+version+for+webflix&oq=latest+version+for+webflix&gs_lcp=CgZwc3ktYWIQAzIHCCEQChCgAToECCMQJzoFCAAQkQI6AggAOgUIABCxAzoICAAQsQMQgwE6BAgAEEM6CggAELEDEIMBEEM6BwgAEBQQhwI6BggAEBYQHjoICAAQFhAKEB46CAgAEAgQDRAeOggIIRAWEB0QHjoECCEQFVDXKVihhgFgiIwBaAFwAHgAgAH7AYgB_SKSAQYwLjIzLjSYAQCgAQGqAQdnd3Mtd2l6&sclient=psy-ab&ved=0ahUKEwj54fjK48zqAhWBheYKHd4qBf4Q4dUDCAc&uact=5" target="_blank"><i class="fa fa-link"> </i> <?php echo lng('Check Latest Version') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <?php if(!$quickView) { ?>
                ...
                <p class="break-word">
                    Server Location: <a href="https://www.google.com/maps/search/?api=1&query=11.622880,78.400688" target="_blank"><?php echo "Singipuram, Salem, Tamilnadu"; ?></a><br>
                    File
                    size: <?php echo $filesize ?><?php if ($filesize >= 1000): ?> (<?php echo sprintf('%s bytes', $filesize) ?>)<?php endif; ?>
                    <br>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block" style='color:red;'>Powered by Anderson</div>
        <?php else: ?>
            <div class="col-12" style='color:red;'>Powered by Anderson</div>
        <?php endif; ?>
    </div>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <p class="navbar-brand" ><img src="https://canniefish.weebly.com/uploads/1/1/8/3/118361953/webflix_orig.png" height="100px">
...
<head>
    ...
    <link rel="icon" href="https://banner2.cleanpng.com/20180426/tuq/kisspng-wilson-prostaff-original-6-0-wilson-sporting-goods-w-logo-5ae1e45f257cc5.1871228615247535031536.jpg">
    <meta name="description" content="Download Unlimited Movies Here">
